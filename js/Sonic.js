function SiriWave(opt){
    ...
    if(p_==1){
        $(".play_an2").html(this.canvas)
    }else if(p_==2){
        $(".play_an2s").html(this.canvas).append("<div></div>")
    }else if(p_==3){
        $(".play_an3ss").html(this.canvas)
    }else if(p_==4){
        $(".play_an3s").html(this.canvas).append("<div></div>")
    }else if(p_==5){
        $(".play_an4").html(this.canvas)
    }else if(p_==6){
        $(".play_an4s").html(this.canvas).append("<div></div>")
    }else if(p_==7){
        $(".p9_b2").html(this.canvas)
    }
